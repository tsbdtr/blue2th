...
## Corpus Check
- 16 files · ~14,846 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 214 nodes · 356 edges · 18 communities (14 shown, 4 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `182c5b24`
...
1. `BluetoothError` - 23 edges
2. `Result` - 18 edges
3. `bt_err_clear()` - 15 edges
4. `obtain_a2dp_proxy()` - 14 edges
5. `enable_bluetooth_inner()` - 14 edges
6. `scan_devices()` - 12 edges
7. `android_jni_env()` - 12 edges
8. `scan_devices_inner()` - 12 edges
9. `DeviceItem()` - 12 edges
10. `find_device_by_name()` - 11 edges
...
Cohesion: 0.12
Nodes (39): Display, Duration, Error, Formatter, GlobalRef, Into, JavaVM, JClass (+31 more)
...
Cohesion: 0.18
Nodes (19): Element, EventHandler, README Project Overview, Signal, enable_bluetooth(), App(), ConfirmModal(), ConnectionStatus (+11 more)
...
Cohesion: 0.12
Nodes (17): JNI Android Bluetooth Detection, Platform-Conditional Compilation (#[cfg(target_os)]), enable_bluetooth_inner(), Vec, scan_devices(), scan_devices_inner(), test_enable_bluetooth_inner_returns_ok_on_non_android(), test_scan_devices_inner_simulation_non_empty() (+9 more)
...
Cohesion: 0.57
Nodes (6): Final Status, Issues Found & Fixed, New Tests Added, Review Report — Load bonded Bluetooth devices, Review Report — Real Bluetooth A2DP Connection, Review Report — Replace confirm modal with Android Bluetooth enable dialog

## Knowledge Gaps
- **85 isolated node(s):** `Display`, `Formatter`, `Into`, `Self`, `Option` (+80 more)
