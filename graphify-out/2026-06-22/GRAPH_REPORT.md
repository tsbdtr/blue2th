# Graph Report - blue2th-play-a-local-audio-file-to-one-connected-speaker-phase-3-pipewire-transport  (2026-06-20)

## Corpus Check
- 27 files · ~24,803 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 492 nodes · 998 edges · 30 communities (24 shown, 6 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 32 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `07e0c23f`
...
6. `AudioEngine` - 15 edges
7. `Json` - 15 edges
8. `android_jni_env()` - 15 edges
9. `obtain_profile_proxy()` - 15 edges
10. `connect_device_inner()` - 15 edges
...
- `test_scan_devices_returns_ok_on_non_android()` --calls--> `scan_devices()`  [INFERRED]
  tests/bluetooth_integration.rs → src/bluetooth.rs
...
Cohesion: 0.10
Nodes (74): JNI Android Bluetooth Detection, Platform-Conditional Compilation (#[cfg(target_os)]), Display, Duration, Error, Formatter, GlobalRef, Into (+66 more)
...
Cohesion: 0.11
Nodes (37): Element, EventHandler, HashSet, README Project Overview, Signal, App(), BackendDeviceItem(), BackendOnline (+29 more)
...
Cohesion: 0.13
Nodes (11): test_connected_device_names_dispatches_to_inner(), test_connected_device_names_empty_on_non_android(), test_connected_device_names_error_path_does_not_panic(), test_connected_device_names_returns_ok_on_non_android(), test_enable_bluetooth_returns_bool(), test_enable_bluetooth_simulation_fallback(), test_request_enable_bluetooth_inner_returns_ok_on_non_android(), test_request_enable_bluetooth_returns_ok_on_non_android() (+3 more)
...
Cohesion: 0.14
Nodes (22): backend_base_url(), BackendError, connect_device(), describe(), disconnect_device(), fetch_devices(), health_url(), ping_backend() (+14 more)
...
Cohesion: 0.07
Nodes (63): AppError, Arc, AudioEngine, AdapterInfo, Address, Box, DeviceInfo, HealthStatus (+55 more)

### Community 24 - "Community 24"
Cohesion: 0.14
Nodes (12): Into, Option, Self, String, AdapterInfo, DeviceInfo, HealthStatus, PlaybackState (+4 more)
...
Cohesion: 0.13
Nodes (17): AudioError, Display, Error, Formatter, PlaybackState, Result, Self, Default (+9 more)

### Community 28 - "Community 28"
Cohesion: 0.18
Nodes (13): AudioError, Error, Into, Self, String, Error, Self, From (+5 more)
...
## Knowledge Gaps
- **143 isolated node(s):** `Into`, `Self`, `Option`, `VolumeRequest`, `PlaybackStatus` (+138 more)
